package com.example.boatgooglefit.widget
...
import com.example.boatgooglefit.R
...
class DotsIndicator : LinearLayout {
    ...
    private var dotHeight: Int = Utils.dpToPx(7)
    private var dotWidth: Int = Utils.dpToPx(7)
    var firstDotHeight: Int = Utils.dpToPx(14)
    var firstDotWidth: Int = Utils.dpToPx(14)
    var marginsBetweenDots: Int = Utils.dpToPx(17)
    var selectedDotScaleFactor: Float = 1.4f
    var selectedDotResource: Int = R.drawable.red_radius
    var unselectedDotResource: Int = R.drawable.gray_radius
    var firstSelectedDotResource: Int = R.drawable.gray_radius
    var firstUnselectedDotResource: Int = R.drawable.gray_radius
